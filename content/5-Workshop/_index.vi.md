...
* **5.1** — [Giới thiệu](5.1-introduction/)
* **5.2** — [Xây dựng hạ tầng mạng](5.2-network-infrastructure/)
...
* **5.6** — [Giám sát hệ thống](5.6-monitoring/)
* **5.7** — [Dọn dẹp tài nguyên](5.7-cleanup/)
