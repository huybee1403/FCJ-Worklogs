...
Confirm the email subscription and generate synthetic load to test the auto-scaling capability.
...
**The Auto Scaling group is in the "At desired capacity" state; view the activity history.**
...
**SSH into the EC2 instance and install the `stress-ng` tool to generate CPU load.**
![Install stress-ng](/images/Screenshot%202026-07-09%20232859.png)

**Run `stress-ng --cpu 4 --timeout 600s` to drive the CPU high, triggering scaling/health events.**
